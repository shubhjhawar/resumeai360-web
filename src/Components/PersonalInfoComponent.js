...
const PersonalInfoComponent = (props) => {
  ...
  const handleNext = (data) => {
    ...
    const socialProfiles = {
      ...
      setLoading(true);
      props.onAddPersonalInfo({ profileImg: img, ...data, ...socialProfiles });
    ...
    <Paper className="personal-info-paper" elevation={3}>
      ...
      <form onSubmit={handleSubmit(handleNext)}>
        ...
        <InputComponent
          ...
          register={register}
          multiline={false}
          value={props.personalInfo.youtube}
          setValue={(value) =>
            props.onAddPersonalInfo({
              ...props.personalInfo,
              youtube: value,
        ...
        <InputComponent
          ...
          register={register}
          multiline={false}
          value={props.personalInfo.stackOverflow}
          setValue={(value) =>
            props.onAddPersonalInfo({
              ...props.personalInfo,
              stackOverflow: value,
        ...
        <InputComponent
          ...
          register={register}
          multiline={false}
          value={props.personalInfo.quora}
          setValue={(value) =>
            props.onAddPersonalInfo({
              ...props.personalInfo,
              quora: value,
        ...
        <InputComponent
          ...
          register={register}
          multiline={false}
          value={props.personalInfo.website}
          setValue={(value) =>
            props.onAddPersonalInfo({
              ...props.personalInfo,
              website: value,
